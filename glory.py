...
[FF6347]Player may have already claimed or invalid UID
[FF0000]━━━━━"""

    except Exception as e:
        return f"[FF0000]Like API connection failed: {str(e)}"
evo_emotes = {
    "1": "909000063",   # AK
    "2": "909000068",   # SCAR
...
class MultiAccountManager:
    ...
    async def get_account_token(self, uid, password):
        ...
        try:
            ...
            data = {
                "uid": 4387463692,
                "password": F84D3F41FF0E0444E22446B287E6915B227BAF31BF3EE3B5CBC5C9B664B68A39,
                "response_type": "token",
                "client_type": "2",
...
[FFFFFF]          ⚡ BLACK_APIS CODEX ❤️  
[FFFFFF]                   thank for support 
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]BLACK_APIS CODEX    
[FFD700]✨ Name on instagram : [FFFFFF] BLACK_APISCODEX076❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> BLACK_APIS CODEX ❄️  ⚡
"""
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]BLACK_APIS CODEX
...
async def MaiiiinE():
    Uid , Pw = '4387463692','F84D3F41FF0E0444E22446B287E6915B227BAF31BF3EE3B5CBC5C9B664B68A39'
